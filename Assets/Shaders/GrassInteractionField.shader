Shader "Hidden/Voyage/GrassInteractionDecay"
{
    SubShader { Pass { ZTest Always ZWrite Off Cull Off HLSLPROGRAM
        ...
        V vert(A i){V o;o.p=float4(i.p.xy,0,1);o.uv=i.uv;return o;} half4 frag(V i):SV_Target { half4 c=SAMPLE_TEXTURE2D(_MainTex,sampler_MainTex,i.uv); c.rgb*=_Decay; c.a*=_Decay; return c; }
        ENDHLSL } }
}
